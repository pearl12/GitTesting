...
function ProductComment(){
	...
	global $fsql,$tsql,$strGuest;
		...
		$scl=" iffb='1' and catid='4' and pid='0' and rid='$productid' ";

		$moreurl=ROOTPATH."comment/class/index.php?catid=4&rid=".$productid;
		...
		//获取标题
		$tsql->query("select title from {P}_product_con where id='$productid'");
		if($tsql->next_record()){
			$title=$tsql->f("title");
		}
