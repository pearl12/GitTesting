...
{
		//global $GLOBALS['strTempNotexists'];
...
function printpage( )
{
		...
		//global $GLOBALS['fsql'];
		//global $GLOBALS['tsql'];
		//global $GLOBALS['reload'];
		//global $GLOBALS['adminMenu'];
		//global $GLOBALS['strMore'];
...
{
		//preg_match_all( "/[\x01-]|[?遌[€-縘|郲?縘[€-縘|[?颹[€-縘[€-縘|餥?縘[€-縘[€-縘|[?鱙[€-縘[€-縘[€-縘/", $str, $ar );
